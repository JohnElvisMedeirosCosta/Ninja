...
*/
pessoa.nomeCompleto(); // 'Olá! Meu nome é John Costa!'
...
*/
for ( var i = 0; i < 3; i++) {
    pessoa.andar(Math.floor(Math.random() * 10 + 1))
}
...
// Agora, apresente-se ;)
pessoa.apresentacao(); //'Olá, eu sou o John Costa, tenho 26 anos, 1.86m, meu peso é 90kg e, só hoje, eu já caminhei 1 metro!'